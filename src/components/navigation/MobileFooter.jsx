...
const MobileFooter = () => {
   return(
    <div className="bg-black p-4 flex flex-row text-center z-10 w-full fixed bottom-0 rounded-t-lg" style={{boxShadow:"0 -1px 20px white"}}>
        <button className="sidenav__button flex flex-row justify-center w-1/5">
