...
const JWT_SECRET = "asdfg"; // This is to be stored in env.local for security purposes.
...
const fetchuser = (req, res, next) => {
    ...
    if(!token){
        return res.status(401).send({error: "Please authenticate usimg a valid token"})
    }
